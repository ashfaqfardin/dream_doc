...
class FluxPipeline(
    ...
    def __call__(
        ...
        Args:
            ...
            invert_image (`bool`, *optional*, defaults to False):
                If True, run forward inversion (returns list of inverted latents).
            inverted_latent_list (list, *optional*):
                List of inverted latents from a previous inversion call. Source latents are replaced at each step.
